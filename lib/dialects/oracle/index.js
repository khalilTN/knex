...
assign(Client_Oracle.prototype, {
  ...
  acquireRawConnection: function acquireRawConnection() {
    ...
    return new Promise(function (resolver, rejecter) {
      client.connectionSettings.connectString = client.connectionSettings.host + '/' + client.connectionSettings.database;
      client.driver.getConnection(client.connectionSettings, function (err, connection) {
        connection = new WrappedConnection(connection);
  ...
  _query: function _query(connection, obj) {
    ...
    return connection.executeAsync(obj.sql, obj.bindings).then(function (response) {
      ...
      obj.response = helpers.group(response);
      return obj;
    });
  },
